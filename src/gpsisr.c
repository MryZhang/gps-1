...
//    printf("%ld\n",prompt_mag); // dith_mag  prompt_mag son un orden de magnitud mas grandes que en la mac.
    if ((dith_mag > acq_thresh) && (prompt_mag > acq_thresh)) {  //VILA esto siempre se cumple, nunca entra al else y nunca expande el rango de busqueda doppler
